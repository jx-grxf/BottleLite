...
- Preview builds are ad-hoc signed and publish SHA-256 checksums plus signed
  Sparkle appcasts. Developer ID signing, Hardened Runtime, and notarization are
  planned once Apple Developer enrollment lands.
